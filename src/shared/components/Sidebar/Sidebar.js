            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              <li className="items-center">
                ...
                >
                  <i
                    className={
                      'fas fa-tv mr-2 text-sm ' + (window.location.href.indexOf('/admin/dashboard') !== -1 ? 'opacity-75' : 'text-blueGray-300')
                    }
                  ></i>{' '}
                  Dashboard
                </Link>
              ...
              <li className="items-center">
                ...
                >
                  <i
                    className={
                      'fas fa-tools mr-2 text-sm ' + (window.location.href.indexOf('/admin/settings') !== -1 ? 'opacity-75' : 'text-blueGray-300')
                    }
                  ></i>{' '}
                  Settings
                </Link>
              ...
              <li className="items-center">
                ...
                >
                  <i
                    className={
                      'fas fa-table mr-2 text-sm ' + (window.location.href.indexOf('/admin/tables') !== -1 ? 'opacity-75' : 'text-blueGray-300')
                    }
                  ></i>{' '}
                  Tables
                </Link>
              ...
              <li className="items-center">
                ...
                >
                  <i
                    className={
                      'fas fa-map-marked mr-2 text-sm ' + (window.location.href.indexOf('/admin/maps') !== -1 ? 'opacity-75' : 'text-blueGray-300')
                    }
                  ></i>{' '}
                  Maps
                </Link>
